...
export function UserRecomBox(){
    ...
    useEffect(()=>{
         ...
         .then(data => {setUserInfo1(prevState => ({ ...prevState,avatar:'./avatar.png',userID: data.randomUser[0].user_id ,username: data.randomUser[0].username,description: data.randomUser[0].description }));
